...
<template>
  <div class="space-y-6">
    <UPageCard
      title="预警阈值配置"
      description="设置各类预警的触发阈值，系统将根据这些阈值自动生成预警。"
      variant="naked"
    ...
    <UPageCard variant="subtle">
      ...
      >
        <UInput
          v-model="alertThresholds.balanceWarningDays"
          type="number"
          class="w-24"
        />
      </UFormField>
      ...
      >
        <UInput
          v-model="alertThresholds.idleAccountDays"
          type="number"
          class="w-24"
        />
      </UFormField>
      ...
      >
        <UInput
          v-model="alertThresholds.banRateThreshold"
          type="number"
          class="w-24"
        />
      </UFormField>
      ...
      >
        <UInput
          v-model="alertThresholds.consumptionDropPercent"
          type="number"
          class="w-24"
        />
      </UFormField>
      ...
      >
        <UInput
          v-model="alertThresholds.reconciliationDiffPercent"
          type="number"
          class="w-24"
        />
      </UFormField>
    ...
    <UPageCard
      title="对账记录"
      description="各渠道月度对账情况，差异超过阈值将标红。"
      variant="naked"
      class="mb-4"
    />
      ...
      <div class="divide-y divide-default">
        ...
        >
          ...
          <div class="flex items-center gap-4 text-sm shrink-0">
            ...
            <UBadge
              :label="reconciliationStatusLabel(record.status)"
              :color="reconciliationStatusColor(record.status)"
              variant="subtle"
              size="xs"
            />
          </div>
